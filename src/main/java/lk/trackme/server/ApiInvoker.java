...
import lk.trackme.server.auth.ApiKeyAuth;
import lk.trackme.server.auth.Authentication;
import lk.trackme.server.auth.HttpBasicAuth;
import lk.trackme.server.request.DeleteRequest;
import lk.trackme.server.request.GetRequest;
import lk.trackme.server.request.PatchRequest;
import lk.trackme.server.request.PostRequest;
import lk.trackme.server.request.PutRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
     ...
     INSTANCE.authentications.put("TrackMe-Api-Key", new ApiKeyAuth("header", "TrackMe-Api-Key"));
