...
import lk.trackme.client.model.auth.Authentication;
import lk.trackme.client.model.auth.ApiKeyAuth;
import lk.trackme.client.model.auth.HttpBasicAuth;
import lk.trackme.client.model.request.GetRequest;
import lk.trackme.client.model.request.PostRequest;
import lk.trackme.client.model.request.PutRequest;
import lk.trackme.client.model.request.DeleteRequest;
import lk.trackme.client.model.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
     ...
     setUserAgent("Swagger-Codegen/1.0.1/android");
